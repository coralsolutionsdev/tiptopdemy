...
class MemorizeController extends Controller
{
    ...
    {
        $input = $request->only(['title', 'description', 'tags', 'time_to_answer', 'level', 'item_type', 'item_title', 'item_status', 'item_media_url', 'form_item_type_title', 'item_question', 'deleted_items']);
