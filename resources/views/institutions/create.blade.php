...
<section>
    @if(!empty($institution))
        {!! Form::open(['url' => route('pages.update', $institution->id),'method' => 'PUT','enctype' => 'multipart/form-data','data-parsley-validate' => true]) !!}
    @else
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row col-lg-12">
                        ...
                        <div class="col-lg-10 padding-0 margin-0">
                            {!! Form::text('title',!empty($institution) ? $institution->title : null,['class' => 'form-control title','required' => true,'placeholder' => 'Title']) !!}
                        </div>
                    </div>
                    <div class="form-group row col-lg-12">
                        <div class="col-lg-2 d-flex align-items-center">{{__('Slug title')}}</div>
                        <div class="col-lg-10 padding-0 margin-0">
                            {!! Form::text('slug',!empty($institution) ? $institution->slug : null,['class' => 'form-control slug','required' => true,'placeholder' => 'slug-title']) !!}
                        </div>
                    </div>
                    <div class="form-group row col-lg-12">
                        <div class="col-lg-2 d-flex align-items-center">{{__('Content')}}</div>
                        <div class="col-lg-10 padding-0 margin-0">
                            {!! Form::textarea('body',!empty($institution->body) ? $institution->body : null,['class' => 'form-control content-editor']) !!}
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row col-lg-12 padding-0 margin-0">
                                ...
                                <div class="col-lg-9" style="padding: 10px 0 10px 10px; margin: 0px">
                                    <input type="checkbox" name="status" class="toogle-switch" value="1" {{empty($institution) || !empty($institution->status) ? 'checked' : null}}>
                                </div>
                            </div>
                            <div class="form-group row col-lg-12 padding-0 margin-0">
                                <div class="col-lg-3 d-flex align-items-center padding-0">{{__('Banners')}}</div>
                                <div class="col-lg-9" style="padding: 10px 0 10px 10px; margin: 0px">
                                    {!! Form::select('banner_id',[null =>'-- Please select banner --'] + $banners, !empty($institution) ? $institution->banner_id : null ,["class" => "form-control"]) !!}
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-5 image-upload">
                    <div class="card border-light" style="min-height: 350px">
                        <div class="card-body">
                            ...
                            @php
                                $attachments_count = 1;
                                $image_source = (!empty($institution) && !empty($institution->image)) ? asset_image($institution->image) : null;
                            @endphp
            ...
            <div class="card border-light">
                ...
                <div class="form-group d-flex align-items-center">
                    ...
                    <div class="col-md-6 {{ $errors->has('url') ? ' has-error' : '' }}">
                        {!! Form::text('slug',!empty($institution) ? $institution->slug : null,['class' => 'form-control slug','required' => true,'placeholder' => 'page-title']) !!}
                          @if ($errors->has('url'))
                              <span class="help-block">
