...
<div class="text-right">
    ...
    <button type="button" class="btn btn-primary btn-lg w-75" data-toggle="modal" data-target="#newalbummodal">
      <span class="fa fa-plus-circle" aria-hidden="true"></span>  <span>{{trans('main._add')}}</span>
    </button>
</div>
<!-- Modal -->
<form method="POST" action="{{route('albums.store')}}" enctype="multipart/form-data" data-parsley-validate>
      {{csrf_field()}}
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header text-white bg-primary">
        <h5 class="modal-title" id="exampleModalLabel">{{trans('main._add')}} {{trans('main._album')}}</h5>
