                        ...
                        <div class="uk-card uk-card-default uk-card-body uk-padding-small uk-text-center"
                                                    ...
                                                    <div class="uk-grid-small" uk-grid style="padding-top: 10px">
                                                        <div class="uk-width-1-2@s">
                                                            <label><input class="uk-radio" type="radio" name="gender"
                                                                          value="1" {{$user->gender == 1 ? 'checked' : ''}}> {{__('Male')}}
                                                            </label>
                                                        </div>
                                                        <div class="uk-width-1-2@s">
                                                            <label><input class="uk-radio" type="radio" name="gender"
                                                                          value="0" {{$user->gender == 0 ? 'checked' : ''}}> {{__('Female')}}
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            @if(false)
                                <div class="uk-margin-small">
                                    ...
                                    <div class="uk-form-controls">
                                        <input class="uk-input {{ $errors->has('mother_name') ? ' uk-form-danger' : '' }}"
                                               name="mother_name" type="text" value="{{ old('mother_name') }}">
                                    </div>
                                </div>
                            @endif
                    ...
                    <li>
                        <div class="uk-card uk-card-default uk-card-body uk-padding-small uk-text-center"
                            ...
                            <div class="uk-margin">
                                <div class="uk-grid-small" uk-grid>
                                    <div class="uk-width-1-6@m uk-flex uk-flex-middle">
                                        <label class="uk-form-label" for="">{{__('main.Current Current password')}}
                                            :</label>
                                    </div>
                                    <div class="uk-width-5-6@m">
                                        <div class="uk-grid-small" uk-grid>
                                        ...
                                        <div class="uk-grid-small" uk-grid>
                                            <div class="uk-inline uk-width-1-2">
                                                <span class="uk-form-icon uk-form-icon-flip"
                                                      uk-icon="icon: lock"></span>
                                                <input class="uk-input {{ $errors->has('password') ? ' uk-form-danger' : '' }}"
                                                       type="password" name="confirm_new_password" placeholder=""
                                                       required>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="uk-margin">
                                ...
                                <div>
                                    <ul class="uk-grid-small uk-child-width-1-2 uk-child-width-1-2@s uk-child-width-1-3@m media-items-list"
                                        ...
                                        @if(!empty($user) && $userMedia = $user->getMedia(\App\Modules\Media\MediaFile::getGroup(\App\Modules\Media\MediaFile::TYPE_PROFILE_IMAGE)))
                                                    ...
                                                    <div class="uk-card uk-card-default uk-card-body uk-padding-remove">
                                                        ...
                                                        <div>
                                                            ...
                                                            <img data-src="{{$image->getFullUrl('card')}}"
                                                                 sizes="(min-width: 650px) 650px, 100vw" width="650"
                                                                 height="433" alt="" uk-img>
                                                        </div>
                                                    </div>
                                                </li>
                                            @endforeach
