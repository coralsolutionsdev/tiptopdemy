                                ...
                                <td>
                                    <div class="action_btn text-right" style="padding-top: 10px">
                                        <ul>
                                            ...
                                            <li class="">
                                                <a href="{{route('store.sets.edit', $item->id)}}" class="btn btn-light"><i class="far fa-edit"></i></a>
                                            </li>
                                            <li class="">
                                                <span id="{{$item->id}}" class="btn btn-light btn-delete"><i class="far fa-trash-alt"></i></span>
                                                <form id="delete-form" method="post" action="{{route('store.sets.destroy', $item->id)}}">
                                                    {{csrf_field()}}
                                                    {{method_field('DELETE')}}
                                                </form>
                                            </li>
