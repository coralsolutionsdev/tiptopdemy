...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" href="themes\adminity_admin\assets\images\favicon.ico" type="image/x-icon">
    <!-- Google font-->
    <link href="https://fonts.googleapis.com/css?family=Open+Sans:400,600" rel="stylesheet">
    <!-- Required Fremwork -->
    <link rel="stylesheet" type="text/css" href="themes\adminity_admin\bower_components\bootstrap\css\bootstrap.min.css">
    <!-- feather Awesome -->
    <link rel="stylesheet" type="text/css" href="themes\adminity_admin\assets\icon\feather\css\feather.css">
    <!-- Style.css -->
    <link rel="stylesheet" type="text/css" href="themes\adminity_admin\assets\css\style.css">
    <link rel="stylesheet" type="text/css" href="themes\adminity_admin\assets\css\jquery.mCustomScrollbar.css">
</head>
        ...
        <nav class="navbar header-navbar pcoded-header">
            <div class="navbar-wrapper">
                ...
                <div class="navbar-logo">
                    ...
                    <a href="index-1.htm">
                        <img class="img-fluid" src="themes\adminity_admin\assets\images\logo.png" alt="Theme-Logo">
                    </a>
                ...
                <div class="navbar-container container-fluid">
                    ...
                    <ul class="nav-right">
                        <li class="header-notification">
                            <div class="dropdown-primary dropdown">
                                ...
                                <ul class="show-notification notification-view dropdown-menu" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                                    ...
                                    <li>
                                        <div class="media">
                                            <img class="d-flex align-self-center img-radius" src="themes\adminity_admin\assets\images\avatar-4.jpg" alt="Generic placeholder image">
                                    ...
                                    <li>
                                        <div class="media">
                                            <img class="d-flex align-self-center img-radius" src="themes\adminity_admin\assets\images\avatar-3.jpg" alt="Generic placeholder image">
                                            <div class="media-body">
                        ...
                        <li class="user-profile header-notification">
                            <div class="dropdown-primary dropdown">
                                <div class="dropdown-toggle" data-toggle="dropdown">
                                    <img src="themes\adminity_admin\assets\images\avatar-4.jpg" class="img-radius" alt="User-Profile-Image">
                                    <span>John Doe</span>
                        ...
                        <div class="main-friend-list">
                            <div class="media userlist-box" data-id="1" data-status="online" data-username="Josephin Doe" data-toggle="tooltip" data-placement="left" title="Josephin Doe">
                                <a class="media-left" href="#!">
                                    <img class="media-object img-radius img-radius" src="themes\adminity_admin\assets\images\avatar-3.jpg" alt="Generic placeholder image ">
                            ...
                            <div class="media userlist-box" data-id="2" data-status="online" data-username="Lary Doe" data-toggle="tooltip" data-placement="left" title="Lary Doe">
                                <a class="media-left" href="#!">
                                    <img class="media-object img-radius" src="themes\adminity_admin\assets\images\avatar-2.jpg" alt="Generic placeholder image">
                                    <div class="live-status bg-success"></div>
                                </a>
                                <div class="media-body">
                            ...
                            <div class="media userlist-box" data-id="3" data-status="online" data-username="Alice" data-toggle="tooltip" data-placement="left" title="Alice">
                                <a class="media-left" href="#!">
                                    <img class="media-object img-radius" src="themes\adminity_admin\assets\images\avatar-4.jpg" alt="Generic placeholder image">
                                    <div class="live-status bg-success"></div>
                                </a>
                                <div class="media-body">
                            ...
                            <div class="media userlist-box" data-id="4" data-status="online" data-username="Alia" data-toggle="tooltip" data-placement="left" title="Alia">
                                <a class="media-left" href="#!">
                                    <img class="media-object img-radius" src="themes\adminity_admin\assets\images\avatar-3.jpg" alt="Generic placeholder image">
                                    <div class="live-status bg-success"></div>
                                </a>
                                <div class="media-body">
        ...
        <div class="showChat_inner">
            ...
            <div class="media chat-messages">
                <a class="media-left photo-table" href="#!">
                    <img class="media-object img-radius img-radius m-t-5" src="themes\adminity_admin\assets\images\avatar-3.jpg" alt="Generic placeholder image">
                </a>
            ...
            <div class="media chat-messages">
                ...
                <div class="media-right photo-table">
                    <a href="#!">
                        <img class="media-object img-radius img-radius m-t-5" src="themes\adminity_admin\assets\images\avatar-4.jpg" alt="Generic placeholder image">
                    </a>
                </div>
            </div>
                ...
                <nav class="pcoded-navbar">
                    <div class="pcoded-inner-navbar main-menu">
                        ...
                        <ul class="pcoded-item pcoded-left-item">
                            ...
                            <li class="">
                                <a href="themes\adminity_admin\extra-pages\landingpage\index.htm" target="_blank">
                            ...
                            <li class="pcoded-hasmenu ">
                                ...
                                <ul class="pcoded-submenu">
                                    ...
                                    <li class="pcoded-hasmenu ">
                                        ...
                                        <ul class="pcoded-submenu">
                                            <li class="">
                                                <a href="themes\adminity_admin\extra-pages\email-templates\email-welcome.htm">
                                                    <span class="pcoded-mtext">Welcome Email</span>
                                                </a>
                                            </li>
                                            <li class="">
                                                <a href="themes\adminity_admin\extra-pages\email-templates\email-password.htm">
                                                    <span class="pcoded-mtext">Reset Password</span>
                                                </a>
                                            </li>
                                            <li class="">
                                                <a href="themes\adminity_admin\extra-pages\email-templates\email-newsletter.htm">
                                                    <span class="pcoded-mtext">Newsletter Email</span>
                                                </a>
                                            </li>
                                            <li class="">
                                                <a href="themes\adminity_admin\extra-pages\email-templates\email-launch.htm">
                                                    <span class="pcoded-mtext">App Launch</span>
                                                </a>
                                            </li>
                                            <li class="">
                                                <a href="themes\adminity_admin\extra-pages\email-templates\email-activation.htm">
                                                ...
                                                <div class="card-block">
                                                    <div class="row m-b-25">
                                                        <div class="col-auto p-r-0">
                                                            <div class="u-img">
                                                                <img src="themes\adminity_admin\assets\images\breadcrumb-bg.jpg" alt="user image" class="img-radius cover-img">
                                                                <img src="themes\adminity_admin\assets\images\avatar-2.jpg" alt="user image" class="img-radius profile-img">
                                                            </div>
                                                        </div>
                                                        <div class="col">
                                                                        ...
                                                                        <tr>
                                                                            <td class="b-none">
                                                                                <a href="#!" class="align-middle">
                                                                                    <img src="themes\adminity_admin\assets\images\avatar-2.jpg" alt="user image" class="img-radius img-40 align-top m-r-15">
        ...
        <ul class="iew-download">
            <li>
                <a href="http://www.google.com/chrome/">
                    <img src="themes/adminity_admin/assets/images/browser/chrome.png" alt="Chrome">
                    <div>Chrome</div>
                </a>
            </li>
            <li>
                <a href="https://www.mozilla.org/en-US/firefox/new/">
                    <img src="themes/adminity_admin/assets/images/browser/firefox.png" alt="Firefox">
                    <div>Firefox</div>
                </a>
            </li>
            <li>
                <a href="http://www.opera.com">
                    <img src="themes/adminity_admin/assets/images/browser/opera.png" alt="Opera">
                    <div>Opera</div>
                </a>
            </li>
            <li>
                <a href="https://www.apple.com/safari/">
                    <img src="themes/adminity_admin/assets/images/browser/safari.png" alt="Safari">
                    <div>Safari</div>
                </a>
            </li>
            <li>
                <a href="http://windows.microsoft.com/en-us/internet-explorer/download-ie">
                    <img src="themes/adminity_admin/assets/images/browser/ie.png" alt="">
                    <div>IE (9 & above)</div>
                </a>
            </li>
        </ul>
...
<!-- Required Jquery -->
<script data-cfasync="false" src="..\..\..\cdn-cgi\scripts\5c5dd728\cloudflare-static\email-decode.min.js"></script><script type="text/javascript" src="themes\adminity_admin\bower_components\jquery\js\jquery.min.js"></script>
<script type="text/javascript" src="themes\adminity_admin\bower_components\jquery-ui\js\jquery-ui.min.js"></script>
<script type="text/javascript" src="themes\adminity_admin\bower_components\popper.js\js\popper.min.js"></script>
<script type="text/javascript" src="themes\adminity_admin\bower_components\bootstrap\js\bootstrap.min.js"></script>
<!-- jquery slimscroll js -->
<script type="text/javascript" src="themes\adminity_admin\bower_components\jquery-slimscroll\js\jquery.slimscroll.js"></script>
<!-- modernizr js -->
<script type="text/javascript" src="themes\adminity_admin\bower_components\modernizr\js\modernizr.js"></script>
<!-- Chart js -->
<script type="text/javascript" src="themes\adminity_admin\bower_components\chart.js\js\Chart.js"></script>
<!-- amchart js -->
<script src="themes\adminity_admin\assets\pages\widget\amchart\amcharts.js"></script>
<script src="themes\adminity_admin\assets\pages\widget\amchart\serial.js"></script>
<script src="themes\adminity_admin\assets\pages\widget\amchart\light.js"></script>
<script src="themes\adminity_admin\assets\js\jquery.mCustomScrollbar.concat.min.js"></script>
<script type="text/javascript" src="themes\adminity_admin\assets\js\SmoothScroll.js"></script>
<script src="themes\adminity_admin\assets\js\pcoded.min.js"></script>
<!-- custom js -->
<script src="themes\adminity_admin\assets\js\vartical-layout.min.js"></script>
<script type="text/javascript" src="themes\adminity_admin\assets\pages\dashboard\custom-dashboard.js"></script>
<script type="text/javascript" src="themes\adminity_admin\assets\js\script.min.js"></script>
