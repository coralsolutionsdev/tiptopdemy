...
{{--    <link rel="stylesheet" href="{{asset('libraries/uikit/css/uikit-rtl.min.css')}}"/>--}}
    ...
    <!-- THEME CSS -->
    <link rel="stylesheet" href="{{url('themes/coral_admin/css/dashboard.css?v=202008200430')}}">
    <link rel="stylesheet" href="{{url('themes/coral_admin/css/general.css?v=202008200430')}}">
    <link rel="stylesheet" href="{{url('themes/general/modules/css/form.css?v=202008200430')}}">
