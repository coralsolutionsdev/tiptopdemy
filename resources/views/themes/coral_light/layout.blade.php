...
<head>
    ...
    @endif
    <!--site Css-->
    <link rel="stylesheet" href="{{url('themes/'.getFrontendThemeName().'/css/general.css?v=202010061500')}}">
        ...
        <div class="uk-child-width-1-1@s uk-text-center" uk-grid>
            <div class="">
                <div class="uk-background-secondary uk-light uk-padding uk-panel">
                    <p class="uk-h5 uk-text-meta">All copy rights are served to TipTop Academy @2020</p>
                </div>
            </div>
        </div>
    </footer >
