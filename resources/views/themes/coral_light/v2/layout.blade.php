...
<head>
    ...
    <!--site Css-->
    <link rel="stylesheet" href="{{asset('themes/'.getFrontendThemeName().'/css/general.css?v=202306240510')}}">
    ...
    <script src="{{asset('themes/'.getFrontendThemeName().'/js/app.js?v=202306240510')}}"></script>
...
<script src="{{asset('js/app.js?v=202306240510')}}"></script>
