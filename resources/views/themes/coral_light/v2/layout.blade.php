...
<head>
    ...
    <!--site Css-->
    <link rel="stylesheet" href="{{asset('themes/'.getFrontendThemeName().'/css/general.css?v=2021051411800')}}">
    ...
    <script src="{{asset('themes/'.getFrontendThemeName().'/js/app.js?v=2021051411800')}}"></script>
...
<script src="{{asset('js/app.js?v=2021051411800')}}"></script>
