...
{{--    <link href="https://unpkg.com/tailwindcss@^2/dist/tailwind.min.css" rel="stylesheet">--}}
    ...
    <!--site Css-->
    <link rel="stylesheet" href="{{asset('themes/'.getFrontendThemeName().'/css/general.css?v=202103082250')}}">
    ...
    <script src="{{asset('themes/'.getFrontendThemeName().'/js/app.js?v=202103082250')}}"></script>
...
<script src="{{asset('js/app.js?v=202103082250')}}"></script>
</body>
</html>